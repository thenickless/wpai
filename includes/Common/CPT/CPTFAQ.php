...
{
    protected $post_type = 'bk_faq';
    protected $templates= [
        'single'  => 'bk_faq-single.php',
        'archive' => 'bk_faq-archive.php',
        'taxonomy' => [
            'category' => 'bk_faq_category.php',
            'tag'      => 'bk_faq_tag.php',
        ],
    ];
    ...
    {
        $this->labels = [
            'name' => _x('FAQ', 'FAQ, synonym or glossary entries', 'wp-ai'),
            'singular_name' => _x('FAQ', 'Single FAQ, synonym or glossary ', 'wp-ai'),
            'menu_name' => __('FAQ', 'wp-ai'),
            'add_new' => __('Add FAQ', 'wp-ai'),
            'add_new_item' => __('Add new FAQ', 'wp-ai'),
            'edit_item' => __('Edit FAQ', 'wp-ai'),
            'all_items' => __('All FAQ', 'wp-ai'),
            'search_items' => __('Search FAQ', 'wp-ai'),
        ];

        $this->taxonomies = [
            [
                'name'            => 'bk_faq_category',
                'label'           => __('FAQ Categories', 'wp-ai'),
                'slug_option_key' => 'website_custom_faq_category_slug',
                'default_slug'    => 'faq_category',
                'rest_base'       => 'bk_faq_category',
                'hierarchical'    => true,
            ],
            [
                'name'            => 'bk_faq_tag',
                'label'           => __('FAQ Tags', 'wp-ai'),
                'slug_option_key' => 'website_custom_faq_tag_slug',
                'default_slug'    => 'faq_tag',
                'rest_base'       => 'bk_faq_tag',
                'hierarchical'    => false,
            ],
        ];
