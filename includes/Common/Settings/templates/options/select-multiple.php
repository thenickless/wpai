...
if (str_starts_with($field_name, 'faq_categories_')) {
    static $wp_ai_import_category_tour_marked = false;
    if (!$wp_ai_import_category_tour_marked) {
        $tour_attr = ' data-bk-tour="import-categories"';
        $wp_ai_import_category_tour_marked = true;
    }
}
?>
<tr valign="top">
